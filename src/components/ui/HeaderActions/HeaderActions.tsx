...
export default function HeaderActions() {
  ...
  setLang(prev => (prev === 'UA' ? 'EN' : 'UA'))
    ...
    return (
      ...
      <button onClick={toggleLang} className="w-[34px] h-[34px] lg:w-[38px] lg:h-[38px] 
      ...
      flex items-center justify-center hover:border-gray-10 hover:text-gray-10">
        <Icon name="icon-user" className="w-[22px] h-[28px] lg:w-[25px] lg:h-[30px]" />
      </Link>
    </div>
    )
};